...
class UserEditPage extends React.Component {
  ...
  goToUserKeys() {
    this.props.history.push(`/keys?type=user&organization=${this.state.organizationName}&user=${this.state.userName}`);
  }
  ...
  getGroups(organizationName) {
    if (!Setting.isGroupAdminOrAdmin(this.props.account)) {
      return;
    }
  ...
  isSelfOrAdmin() {
    return this.isSelf() || Setting.isGroupAdminOrAdmin(this.props.account);
  }
  ...
  renderAccountItem(accountItem) {
    const isAdmin = Setting.isGroupAdminOrAdmin(this.props.account);
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col style={{paddingRight: "20px"}} span={5} >
            <Input
              ...
              style={{width: "280Px"}}
              disabled={!Setting.isGroupAdminOrAdmin(this.props.account) ? true : disabled}
              onChange={e => {
          ...
          <Col span={22} >
            <Row style={{marginTop: "20px", marginBottom: "20px"}} >
              <Col span={22}>
                ...
                <Button type="primary" onClick={() => this.goToUserKeys()}>
